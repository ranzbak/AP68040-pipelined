...
wire        fp_ia_we, fp_cr_we, fp_exc_req;
wire  [7:0] fp_exc_vec;
...
wire        fp_used, fp_frst, fp_fridle, fp_bsun_en, fp_bsun_req;
wire  [3:0] fp_fpcc;
...
`endif
`ifndef FPU_REAL
// only the real unit has control registers or arithmetic exceptions; without
...
assign fp_used = 1'b0;
assign fp_fpcc = 4'd0, fp_bsun_en = 1'b0;
